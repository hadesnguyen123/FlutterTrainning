...
List<UserModel> users = [
  ...
  UserModel(id: '2', name: 'Tommy', avatarUrl: 'https://randomuser.me/api/portraits/men/2.jpg'),
...
List<MessageModel> messages = [
  MessageModel(senderId: '1', text: 'Hello! How are you?', time: '09:25 AM', isSentByMe: false),
  MessageModel(senderId: 'me', text: 'You did your job well!', time: '09:26 AM', isSentByMe: true),
  MessageModel(senderId: '1', text: 'Have a great working week!', time: '09:27 AM', isSentByMe: false),
];
